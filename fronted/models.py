...
class Item(models.Model):
    ...
    slug=models.SlugField() #read its benfits instead of id
    description=models.TextField()
    image=models.ImageField() #check pillow

    def __str__(self): #in admin side whenever we save it save by its title
        return self.title
    ...
    def get_item_url(self):
        return reverse('fronted:detail' , kwargs={'slug':self.slug})
